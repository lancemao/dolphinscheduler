...
package org.apache.dolphinscheduler.server.master.engine.executor.plugin.loop;
...
import org.apache.dolphinscheduler.plugin.task.api.parameters.LoopParameters;
...
@Slf4j
public class LoopLogicTask extends AbstractLogicTask<LoopParameters> {

    private final TaskInstanceDao taskInstanceDao;

    private final TaskInstance taskInstance;

    public LoopLogicTask(IWorkflowExecutionRunnable workflowExecutionRunnable,
    ...
    private DependResult calculateConditionResult() {
        ...
        LoopParameters.LoopDependency dependence = taskParameters.getDependence();
    ...
    @Override
    public ITaskParameterDeserializer<LoopParameters> getTaskParameterDeserializer() {
        return taskParamsJson -> JSONUtils.parseObject(taskParamsJson, new TypeReference<LoopParameters>() {
        });
    }
