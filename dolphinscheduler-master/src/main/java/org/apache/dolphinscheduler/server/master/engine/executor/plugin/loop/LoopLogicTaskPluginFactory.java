...
@Slf4j
@Component
public class LoopLogicTaskPluginFactory implements ILogicTaskPluginFactory<LoopLogicTask> {
    ...
    @Override
    public LoopLogicTask createLogicTask(final ITaskExecutor taskExecutor) {
        ...
        return new LoopLogicTask(workflowExecutionRunnable, taskExecutionContext, taskInstanceDao);
    }
